...
async def start_cmd(message: types.Message):
    ...
    start_count += 1
    await message.reply("""Привет! Это бот с разными моделями! У нас есть GPT-3, GPT-3.5, Pixart и другие модели

В боте мы ещё иногда раздает разные призы.

Команды:
/gpt PROMPT (GPT-3)
/gpt35 PROMPT (GPT-3.5)
/pixart PROMPT (Pixart)
/zephyr PROMPT (zephyr)
/sdxl PROMPT (Stable Diffusion XL)

Наш бот умеет:
1. Писать, делать коды
2. Создавать изображения по запросу.

⛎ Так же в боте доступны роли, админы. 
