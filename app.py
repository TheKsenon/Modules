...
API_KEY = "AIzaSyBkUfZ2K0ERECNUayBv_A5pRIvBrMlDoG"
...
framework = "Regular CSS use flex grid etc, use best libs to best result"  # Change this to "Bootstrap" or any other framework as needed
